...
energy_water_conf={'deconv':[],'int_grads':[],'shap':[],'lrp':[]}
energy_water_sup={'deconv':[],'int_grads':[],'shap':[],'lrp':[]}
energy_water_no={'deconv':[],'int_grads':[],'shap':[],'lrp':[]}

energy_no_water_conf={'deconv':[], 'int_grads':[], 'shap':[], 'lrp':[]}
energy_no_water_sup={'deconv':[], 'int_grads':[], 'shap':[], 'lrp':[]}
energy_no_water_no={'deconv':[], 'int_grads':[], 'shap':[], 'lrp':[]}
...
with open(f'energy_water_conf_pred_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_water_conf, f)    
with open(f'energy_water_sup_pred_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_water_sup, f)    
with open(f'energy_water_no_pred_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_water_no, f)    
    
with open(f'energy_no_water_conf_pred_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_no_water_conf, f)    
with open(f'energy_no_water_sup_pred_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_no_water_sup, f)    
with open(f'energy_no_water_no_pred_{model_ind}.pickle', 'wb') as f:
