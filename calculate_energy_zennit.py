...
for i,w_image in enumerate(watermark_dataset):
    ...
    a_conf_w = lrp(example, model_conf, target, DEVICE)
    a_sup_w = lrp(example, model_sup, target, DEVICE)
    a_no_w = lrp(example, model_no, target, DEVICE)
    ...
    a_conf_nw = lrp(example_nw, model_conf, target_nw, DEVICE)
    a_sup_nw = lrp(example_nw, model_sup, target_nw, DEVICE)
    a_no_nw = lrp(example_nw, model_no, target_nw, DEVICE)
...
with open(f'zennit_energy_water_conf_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_water_conf, f)    
with open(f'zennit_energy_water_sup_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_water_sup, f)    
with open(f'zennit_energy_water_no_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_water_no, f)    
    
with open(f'zennit_energy_no_water_conf_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_no_water_conf, f)    
with open(f'zennit_energy_no_water_sup_{model_ind}.pickle', 'wb') as f:
    pickle.dump(energy_no_water_sup, f)    
with open(f'zennit_energy_no_water_no_{model_ind}.pickle', 'wb') as f:
