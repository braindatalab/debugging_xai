...
with open(f'./energies/energy_water_conf_pred_{split}.pickle', 'wb') as f:
    pickle.dump(energy_water_conf, f)    
with open(f'./energies/energy_water_sup_pred_{split}.pickle', 'wb') as f:
    pickle.dump(energy_water_sup, f)    
with open(f'./energies/energy_water_no_pred_{split}.pickle', 'wb') as f:
    pickle.dump(energy_water_no, f)    
    
with open(f'./energies/energy_no_water_conf_pred_{split}.pickle', 'wb') as f:
    pickle.dump(energy_no_water_conf, f)    
with open(f'./energies/energy_no_water_sup_pred_{split}.pickle', 'wb') as f:
    pickle.dump(energy_no_water_sup, f)    
with open(f'./energies/energy_no_water_no_pred_{split}.pickle', 'wb') as f:
